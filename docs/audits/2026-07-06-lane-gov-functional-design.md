...
| 8 | ruff pre-commit gate | **PRUNED 2026-07-04** ([#244] P2 n=1 remove-leg; deploy `31e785d`) — lint now manual via §4 `ruff check` / `check.ps1` | n/a (removed) | Precedent: prunes are first-class, evidence-based deploys |
